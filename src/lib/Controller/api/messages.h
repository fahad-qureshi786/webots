...
#define C_SUPERVISOR_NODE_ADD_FORCE 190
#define C_SUPERVISOR_NODE_ADD_FORCE_WITH_OFFSET 191
#define C_SUPERVISOR_NODE_ADD_TORQUE 192
#define C_SUPERVISOR_VIRTUAL_REALITY_HEADSET_IS_USED 193
#define C_SUPERVISOR_VIRTUAL_REALITY_HEADSET_GET_POSITION 194
#define C_SUPERVISOR_VIRTUAL_REALITY_HEADSET_GET_ORIENTATION 195
