...
#define C_DIFFERENTIAL_WHEELS_GET_ENCODERS 20
...
#define C_DIFFERENTIAL_WHEELS_SET_SPEED 47
#define C_DIFFERENTIAL_WHEELS_ENCODERS_SET_SAMPLING_PERIOD 48
#define C_DIFFERENTIAL_WHEELS_ENCODERS_SET_VALUE 49
