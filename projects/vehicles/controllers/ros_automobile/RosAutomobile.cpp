...
void RosAutomobile::launchRos(int argc, char **argv) {
  ...
  // add services
  mEnableIndicatorAutoDisabling = nodeHandle()->advertiseService(name() + "/automobile/enable_indicator_auto_disabling",
                                                                 &RosAutomobile::enableIndicatorAutoDisablingCallback, this);
  mEnableLimitedSlipDifferential = nodeHandle()->advertiseService(name() + "/automobile/enable_limited_slip_differential",
                                                                  &RosAutomobile::enableLimitedSlipDifferentialCallback, this);
  mGetAntiFogLightServer =
    nodeHandle()->advertiseService(name() + "/automobile/get_antifog_light", &RosAutomobile::getAntiFogLightCallback, this);
  mGetBackwardsLightServer =
    nodeHandle()->advertiseService(name() + "/automobile/get_backwards_light", &RosAutomobile::getBackwardsLightCallback, this);
  mGetBrakeLightsServer =
    nodeHandle()->advertiseService(name() + "/automobile/get_brake_light", &RosAutomobile::getBrakeLightsCallback, this);
  mGetControlModeServer =
    nodeHandle()->advertiseService(name() + "/automobile/get_control_mode", &RosAutomobile::getControlModeCallback, this);
  mGetCruisingSpeedServer =
    nodeHandle()->advertiseService(name() + "/automobile/get_cruising_speed", &RosAutomobile::getCruisingSpeedCallback, this);
  mGetDimensionsServer =
    nodeHandle()->advertiseService(name() + "/automobile/get_dimensions", &RosAutomobile::getDimensionsCallback, this);
  mGetDippedBeamServer =
    nodeHandle()->advertiseService(name() + "/automobile/get_dipped_beam", &RosAutomobile::getDippedBeamCallback, this);
  mGetEngineTypeServer =
    nodeHandle()->advertiseService(name() + "/automobile/get_engine_type", &RosAutomobile::getEngineTypeCallback, this);
  ...
  mGetGearNumberServer =
    nodeHandle()->advertiseService(name() + "/automobile/get_gear_number", &RosAutomobile::getGearNumberCallback, this);
  mGetHazardFlashersServer =
    nodeHandle()->advertiseService(name() + "/automobile/get_hazard_flashers", &RosAutomobile::getHazardFlashersCallback, this);
  mGetIndicatorServer =
    nodeHandle()->advertiseService(name() + "/automobile/get_indicator", &RosAutomobile::getIndicatorCallback, this);
  mGetIndicatorPeriodServer = nodeHandle()->advertiseService(name() + "/automobile/get_indicator_period",
                                                             &RosAutomobile::getIndicatorPeriodCallback, this);
  mGetAutomobileTypeServer =
    nodeHandle()->advertiseService(name() + "/automobile/get_type", &RosAutomobile::getAutomobileTypeCallback, this);
  mGetWiperModeServer =
    nodeHandle()->advertiseService(name() + "/automobile/get_wiper_mode", &RosAutomobile::getWiperModeCallback, this);
  mGetWipersModeServer =
    nodeHandle()->advertiseService(name() + "/automobile/get_wipers_mode", &RosAutomobile::getWiperModeCallback, this);
  mSetAntiFogLightServer =
    nodeHandle()->advertiseService(name() + "/automobile/set_antifog_light", &RosAutomobile::setAntiFogLightCallback, this);
  mSetBrakeServer =
    nodeHandle()->advertiseService(name() + "/automobile/set_brake_intensity", &RosAutomobile::setBrakeCallback, this);
  mSetCruisingSpeedServer =
    nodeHandle()->advertiseService(name() + "/automobile/set_cruising_speed", &RosAutomobile::setCruisingSpeedCallback, this);
  mSetDippedBeamServer =
    nodeHandle()->advertiseService(name() + "/automobile/set_dipped_beam", &RosAutomobile::setDippedBeamCallback, this);
  mSetGearServer = nodeHandle()->advertiseService(name() + "/automobile/set_gear", &RosAutomobile::setGearCallback, this);
  mSetIndicatorServer =
    nodeHandle()->advertiseService(name() + "/automobile/set_indicator", &RosAutomobile::setIndicatorCallback, this);
  mSetIndicatorPeriodServer = nodeHandle()->advertiseService(name() + "/automobile/set_indicator_period",
                                                             &RosAutomobile::setIndicatorPeriodCallback, this);
  mSetHazardFlashersServer =
    nodeHandle()->advertiseService(name() + "/automobile/set_hazard_flashers", &RosAutomobile::setHazardFlashersCallback, this);
  mSetSteeringAngleServer =
    nodeHandle()->advertiseService(name() + "/automobile/set_steering_angle", &RosAutomobile::setSteeringAngleCallback, this);
  mSetThrottleServer =
    nodeHandle()->advertiseService(name() + "/automobile/set_throttle", &RosAutomobile::setThrottleCallback, this);
  mSetWiperModeServer =
    nodeHandle()->advertiseService(name() + "/automobile/set_wiper_mode", &RosAutomobile::setWiperModeCallback, this);
  mSetWipersModeServer =
    nodeHandle()->advertiseService(name() + "/automobile/set_wipers_mode", &RosAutomobile::setWiperModeCallback, this);
  ...
  mRightSteeringAnglePublisher =
    nodeHandle()->advertise<webots_ros::Float64Stamped>(name() + "/automobile/right_steering_angle", 1);
  mLeftSteeringAnglePublisher =
    nodeHandle()->advertise<webots_ros::Float64Stamped>(name() + "/automobile/left_steering_angle", 1);
  mThrottlePublisher = nodeHandle()->advertise<webots_ros::Float64Stamped>(name() + "/automobile/throttle", 1);
  mWheelEncoderPublisher[0] =
    nodeHandle()->advertise<webots_ros::Float64Stamped>(name() + "/automobile/front_right_wheel_encoder", 1);
  mWheelEncoderPublisher[1] =
    nodeHandle()->advertise<webots_ros::Float64Stamped>(name() + "/automobile/front_left_wheel_encoder", 1);
  mWheelEncoderPublisher[2] =
    nodeHandle()->advertise<webots_ros::Float64Stamped>(name() + "/automobile/rear_right_wheel_encoder", 1);
  mWheelEncoderPublisher[3] =
    nodeHandle()->advertise<webots_ros::Float64Stamped>(name() + "/automobile/rear_left_wheel_encoder", 1);
  mWheelSpeedPublisher[0] =
    nodeHandle()->advertise<webots_ros::Float64Stamped>(name() + "/automobile/front_right_wheel_speed", 1);
  mWheelSpeedPublisher[1] =
    nodeHandle()->advertise<webots_ros::Float64Stamped>(name() + "/automobile/front_left_wheel_speed", 1);
  mWheelSpeedPublisher[2] =
    nodeHandle()->advertise<webots_ros::Float64Stamped>(name() + "/automobile/rear_right_wheel_speed", 1);
  mWheelSpeedPublisher[3] =
    nodeHandle()->advertise<webots_ros::Float64Stamped>(name() + "/automobile/rear_left_wheel_speed", 1);
}
