function rgb = wb_camera_recognition_get_segmentation_image(tag)
% Usage: wb_camera_recognition_get_segmentation_image(tag)
...
pointer = calllib('libController', 'wb_camera_recognition_get_segmentation_image',tag);
