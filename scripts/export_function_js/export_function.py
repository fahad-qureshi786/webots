...
functionName = list(functionName) + ["_wr_config_enable_point_size, _wr_config_get_line_scale, _wr_config_get_max_active_directional_light_count, _wr_config_get_max_active_point_light_count, _wr_config_get_max_active_spot_light_count"]
